 ...
 * LookUp Service - Lookup service object is responsible(责任) to get relative(相对) business implementation(实现) and provide business object access to business delegate object. Business Service - Business Service interface. Concrete classes implement this business service to provide actual business implementation logic.
 */
