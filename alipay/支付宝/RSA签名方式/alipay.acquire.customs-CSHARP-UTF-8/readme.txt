    ...
    ────┤           支付宝代码示例结构说明             ├────
            ╰───────────────────────╯ 
　                                                                  
　       接口名称：支付宝报关接口（alipay.acquire.customs）
　 　    代码版本：3.3
...
alipay.acquire.customs-CSHARP-UTF-8
  │
  ├app_code ┈┈┈┈┈┈┈┈┈┈类文件夹
  │  │
  ...
  ├customs.aspx ┈┈┈┈┈┈┈┈支付宝接口入口文件
  ├customs.aspx.cs┈┈┈┈┈┈┈支付宝接口入口文件 
  ├query.aspx ┈┈┈┈┈┈┈┈支付宝接口入口文件
  ├query.aspx.cs┈┈┈┈┈┈┈支付宝接口入口文件
  │
...
alipay_config.cs
default.aspx
default.aspx.cs 统一命名空间为：namespace Com.Alipiay
